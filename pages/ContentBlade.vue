  ...
  <div>
    ...
    <div class="container margin-vertical-2">
      ...
      <ul>
        ...
        <li>image: (optional - specs say can only have 1 image OR 1 video)</li>
        <li>altText: (optional, but highly recommended)</li>
        <li>video: iframe url for vimeo or youtube (optional - specs say can only have 1 image OR 1 video)</li>
        <li>alignment: aligns the image/video, can be left or right (optional - the default is left)</li>
        <li>cta: text for the button (optional)</li>
        <li>ctaLink: url for the button (optional, but required if cta is given)</li>
      </ul>
    ...
    >
      <template slot="content">
        <h4>Lorem ipsum dolor site amet.</h4>
