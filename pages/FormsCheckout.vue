        ...
        <div class="container">
            ...
            <div class="grid-x grid-margin-x">
                <div class="cell medium-6">
                    <label class="margin-bottom-1">State*
                        <select class="margin-bottom-0" id="state" required>
                            <option value=""></option>
                ...
                <div class="cell medium-6">
                    <label>Zip*
                        <input class="margin-bottom-0" type="text" id="zip" required>
                    </label>
                </div>
            </div>
            ...
            <fieldset class="large-7 cell margin-bottom-1">
                <input id="billingSameAsShipping" class="billingSameAsShipping" type="checkbox"><label
                    for="billingSameAsShipping">Same as
            ...
            <div class="billingAddress">
                <div class="grid-x grid-margin-x">
                    <div class="cell small-12 medium-6">
                        ...
                        <input type="text" id="billing-firstName" required>
                    </div>
                    <div class="cell small-12 medium-6">
                        <label for="billing-lastName">Last Name*</label>
                        <input type="text" id="billing-lastName" required>
                    </div>
                </div>
                <label>Country*
                ...
                <label>Address 1*
                    <input type="text" id="billing-address1" required>
                </label>
                <label>Address 2
                ...
                <div class="grid-x grid-margin-x">
                    <div class="cell medium-6">
                        <label class="margin-bottom-1">State*
                            <select class="margin-bottom-0" id="billing-state" required>
                                <option value=""></option>
                                <option value="AL">Alabama</option>
                                <option value="AK">Alaska</option>
                                <option value="AZ">Arizona</option>
                    ...
                    <div class="cell medium-6">
                        <label>Zip*
                            <input class="margin-bottom-0" type="text" id="billing-zip" required>
                        </label>
                    </div>
                </div>
            </div>
            ...
            <p>If you'd like to apply a gift certificate to this purchase, please enter the code below and click the
                "Apply" button to recalculate your balance.</p>
            <div class="input-group">
                <label class="hide-ally-element" for="giftCertificateCode">Gift Certificate Code</label>
                <input class="large-input" type="text" id="giftCertificateCode">
                <div class="input-group-button">
                    <input type="submit" class="button purple" value="Apply">
                </div>
            </div>
            ...
            <form class="card-information">
                ...
                <img src="../assets/images/logo-amex.png" alt="american express">
                <img src="../assets/images/logo-discover.png" alt="discover">
                <div class="grid-x grid-margin-x margin-top-1">
                    ...
                    <div class="cell small-12 medium-6">
                        ...
                        <div class="grid-x grid-margin-x">
                            ...
                            <div class="cell auto">
                                <label style="width: 75px">CVC*
                                    <input type="number" id="card-cvc" required>
                                </label>
                            </div>
                        </div>
                    </div>
