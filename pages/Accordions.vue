    ...
    <div>
        <div class="container">
            ...
            <ul class="margin-bottom-2">
                ...
                <li>closeAll - set to true if all accordions are closed on load (optional, by default the first item is
                    open)
                </li>
            </ul>
            ...
            <ul class="margin-bottom-2">
                <li>openOnLoad - set to true if you want this item to be open - only the first item is open by default
                </li>
            </ul>
