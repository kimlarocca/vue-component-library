<template>
  <div class="style-guide">
    ...
    <div class="container">
      ...
      <section class="section-border">
        <p>Normal paragraph text! Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
      ...
      <h2 class="margin-bottom-1" id="layouts">layouts</h2>
